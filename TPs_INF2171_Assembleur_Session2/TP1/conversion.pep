...
;TP1
;Ce programme convertie un décimal à une base entre 2 et 36 selon le choix de l'utilisateur.
         LDX     0,i  
         STRO    m_s_n,d     ;
         DECI    nbr,d 
;
...
;
         ...
         BR      loop2
;
floop23: STRO    m_s_r,d     ;System.out.println("Resultat: ")
         LDA     nbr,d
;
